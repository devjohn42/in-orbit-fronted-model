	...
	return (
		<DialogPortal>
			...
			<DialogPrimitive.DialogContent
				{...props}
				className="fixed z-50 right-0 top-0 bottom-0 w-100 h-screen border-l border-zinc-900 bg-zinc-950 p-8"
			/>
		</DialogPortal>
	)
}
...
export function DialogTitle(props: DialogPrimitive.DialogTitleProps) {
	return <DialogPrimitive.DialogTitle {...props} className="text-lg font-semibold" />
}
