...
export function UserLevelBar() {
	...
	const percentage = Math.round((data.experience * 100) / data.experienceToNextLevel)

	return (
		<div className="max-w-55 w-full flex flex-col gap-1">
			<div className="flex items-center w-full px-2 justify-between text-xs text-zinc-200">
