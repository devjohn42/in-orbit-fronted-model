...
export const CreateGoal200 = {} as const
...
export const CreateGoalCompletion201 = {} as const
...
export const createGoalCompletion = async (
	...
	return {
		...
		status: res.status,
		headers: res.headers
	} as createGoalCompletionResponse
}
...
export const useCreateGoalCompletion = <TError = unknown, TContext = unknown>(
	options?: {
		mutation?: UseMutationOptions<
			Awaited<ReturnType<typeof createGoalCompletion>>,
			TError,
...
>(options?: {
	query?: Partial<
		UseQueryOptions<Awaited<ReturnType<typeof getUserExperienceAndLevel>>, TError, TData>
	>
	fetch?: RequestInit
}) => {
	const { query: queryOptions, fetch: fetchOptions } = options ?? {}
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserExperienceAndLevel>>> = ({
		signal
	}) => getUserExperienceAndLevel({ signal, ...fetchOptions })
